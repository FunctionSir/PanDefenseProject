...
救救孩子...... --鲁迅  
当前版本: 1.8.2; 条目数: 190, 80 (机构列表, 相关文章); 最后更新: 2026-06-20.
...
本项目的姊妹项目(停更状态, 不过欢迎Fork): [Anti Kidnapping Beacon Project](https://github.com/FunctionSir/AKBP).  

## 近期确实比较忙

最近一段时间, 我可以花费在该项目上的时间并不算充裕, 所以基本没有在收集新的机构, 一些提交请求也很多时候会搁置不断的时间. 在此表示抱歉.  
若可以的话, 您可以选择Fork一份. 既算是一种备份, 也可以在您的Repo处进行一些例如整合, 更新, 或是加入新条目等操作.  
若您愿意把您的更改SQL(模板参考后文的贡献指南)用邮件发我一份, 那么, 不胜感激. 若我再有时间, 会去查看一下, 然后进行一些操作等.  
总之, 十分感谢各位贡献者.  
